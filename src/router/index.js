    ...
    children: [
      {
        ...
        name: 'Dashboard',
        component: Dashboard,
        meta:{title:'Dashboard',allowedRoles: ["Admin", "superadmin","Doctor"] }
      },
      {
        path:'change-password',
        name:'Change Password',
        component:changePassword,
        meta: {title: 'Change Password', allowedRoles: ["Admin", "superadmin","Doctor","insurance"] }
      },
      {
        path: "/profile",
        name: "UserProfile",
      ...
      },
      {
        ...
        name: "Dairies",
        component: DairyList,
        meta: { requiresAuth: true, title: "Dairy Management",allowedRoles: ["superadmin"]  }, // Add this route to the auth-required section
        children: [
          {
            path: "add",
            name: "AddDairy",
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: "Center Management",allowedRoles: ["Admin","superadmin"]  }, // Add this route to the auth-required section
        children: [
          {
            path: "add",
            name: "AddCenter",
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: "Doctor Management",allowedRoles: ["Admin","superadmin"]  }, // Add this route to the auth-required section
        children: [
          {
            path: "add",
            name: "AddDoctor",
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: "Insurance Company Management",allowedRoles: ["superadmin"]  }, // Add this route to the auth-required section
        children: [
          {
            path: "add",
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: "Policy Management",allowedRoles: ["insurance"]  }, // Add this route to the auth-required section
        children: [
          {
            path: "add",
            name: "AddPolicy",
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: "Cattle Management",allowedRoles: ["Doctor",'insurance','Admin','superadmin']  }, // Add this route to the auth-required section
        children: [
          {
            path: "add/:policyId",
            name: "AddCattle",
